...
/// 左滑列表，只有一个可以打开
class QuLeftSD extends StatefulWidget {
  final int count;
  final QuLeftSDItem Function(BuildContext, int) builder;
  ...
  @override
  _QuLeftSDState createState() => _QuLeftSDState();
}

class _QuLeftSDState extends State<QuLeftSD> {
