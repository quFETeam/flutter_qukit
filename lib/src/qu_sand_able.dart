...
//图片越大，反应越慢
class QuSandAble extends StatefulWidget {
  // 将需要沙化的内容包裹起来
  final Widget child;
  // 吹散动画的时间
  ...
  QuSandAble(
      ...
      : super(key: key);
  @override
  _QuSandAbleState createState() => _QuSandAbleState();
}

class _QuSandAbleState extends State<QuSandAble> with TickerProviderStateMixin{
  // 吹散动画Controller
